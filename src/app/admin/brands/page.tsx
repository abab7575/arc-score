          ...
          <form onSubmit={handleAddBrand} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white text-sm placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-[#0259DD]"
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#0259DD]"
              >
                {categories.map((c) => (
      ...
      {tab === "submissions" && (
        <div className="space-y-3">
          {submissions.length === 0 && (
            <div className="bg-white/5 border border-white/10 rounded-xl px-5 py-8 text-center text-white/30 text-sm">
          ...
          {submissions.map((sub) => (
            ...
            >
              <div>
                <p className="text-sm font-medium text-white">{sub.brandName}</p>
